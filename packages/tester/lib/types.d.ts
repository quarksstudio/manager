export declare const CERTIFICATION_TIERS: readonly ["TIER_1", "TIER_2", "TIER_3", "TIER_4"];
export type CertificationTier = (typeof CERTIFICATION_TIERS)[number];
export type AchievedTier = CertificationTier | 'FAILED';
export declare function parseCertificationTier(value: string): CertificationTier;
...
export type SkillAssertion = EqualsAssertion | RegexAssertion | SchemaAssertion | FileCreatedAssertion | FileMatchAssertion;
export type AgentAssertion = RegexAssertion | TrajectoryAssertion | MaxStepsAssertion;
