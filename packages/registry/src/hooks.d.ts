import { type PackageSearchItem, type SearchFilters, type SearchOptions } from './search-packages';
import { type AuthSession, type AuthStep, type LoginOptions } from './auth-login';
...
export declare function useSearchPackages(initialFilters?: SearchFilters): UseSearchPackagesReturn;
export declare function useFetchPackage<T = Record<string, unknown>>(name: string): RegistryQuery<T>;
export declare function useCurrentUser<T = Record<string, unknown>>(): RegistryQuery<T>;
export {};
